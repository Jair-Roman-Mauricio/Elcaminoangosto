...
| Servicio | URL | Notas |
|---|---|---|
| `api` | https://api-production-f113.up.railway.app | health en `/api/health` |
| `web` | https://web-production-551e4.up.railway.app | SPA estática |
| `worker` | — | sin dominio; consume la cola |
| `Redis` | interno | referenciado como `${{Redis.REDIS_URL}}` |

...
export function PlayerBar() {
  ...
  // La escucha se cuenta aquí, no en la pantalla de Alabanza: el reproductor
  // sobrevive a la navegación, así que es el único sitio que sabe qué suena.
  useRegistrarVista('SONG', pista?.songId)
